...
fun printMultiplicationProcess(lhv: Int, rhv: Int, outputName: String) {
    ...
    File(outputName).bufferedWriter().use {
        ...
        it.newLine()
        it.write(String.format("*" + "%${stringLength - 1}d", rhv))
        it.newLine()
        for (j in 0 until stringLength) it.write("-")
        it.newLine()
        var i = 0
        while (rhv1 != 0) {
            if (i != 0) it.write("+" + String.format("%${stringLength - 1 - i}d", lhv * (rhv1 % 10)))
            else it.write(String.format("%${stringLength}d", lhv * (rhv1 % 10)))
            rhv1 /= 10
            i++
            it.newLine()
        }
        for (j in 0 until stringLength) it.write("-")
        it.newLine()
        it.write(String.format("%${stringLength}d", lhv * rhv))
    }
}
